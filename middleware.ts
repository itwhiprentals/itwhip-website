...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  const csp = [
    ...
    "connect-src 'self' https://www.google.com https://*.googleapis.com https://api.stripe.com https://*.firebaseio.com https://*.firebaseapp.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://cloudflareinsights.com https://api.mapbox.com https://*.tiles.mapbox.com https://events.mapbox.com https://res.cloudinary.com https://api.cloudinary.com https://api.smartcar.com https://lh3.googleusercontent.com https://images.unsplash.com wss://*.twilio.com https://*.twilio.com",
