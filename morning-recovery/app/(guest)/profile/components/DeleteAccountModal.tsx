              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    ...
                    <span className="text-sm text-gray-700 dark:text-gray-300">Your profile and personal information</span>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <IoCarOutline className="w-4 h-4 text-gray-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Booking history and trip records</span>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <IoCardOutline className="w-4 h-4 text-gray-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Saved payment methods</span>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
