              ...
              {stats && (
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                    ({reviewData.length} {reviewData.length === 1 ? 'review' : 'reviews'})
                  </span>
                </div>
              )}
            </div>
        ...
        <div className="relative">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between p-3 sm:p-4 pt-0 mt-auto">
                        ...
                        {review.tripStartDate && (
                          <>
                            ...
                            <span className="truncate">
                              {getTimeAgo(review.tripStartDate)}
                            </span>
                          </>
                        )}
                      </div>
                      ...
                      >
                        ...
                        <span>
                          {helpfulClicked.has(review.id) ? 'Thanks!' : review.helpfulCount > 0 ? review.helpfulCount : 'Helpful'}
                        </span>
                      </button>
                    </div>
                  </div>
          ...
          <div className="text-center pb-4">
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
              Showing all {reviewData.length} reviews • Scroll to see more →
            </p>
          </div>
        </div>
      </div>
