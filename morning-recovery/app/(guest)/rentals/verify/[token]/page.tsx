...
import DocumentUpload from '@/app/(guest)/rentals/components/verification/DocumentUpload'
import VerificationStatus from '@/app/(guest)/rentals/components/verification/VerificationStatus'
import GuestPrompt from '@/app/(guest)/rentals/components/verification/GuestPrompt'
import { 
  IoArrowBackOutline,
  IoCarOutline,
  IoWarningOutline,
