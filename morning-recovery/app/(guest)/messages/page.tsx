...
export default function GuestMessagesPage() {
  ...
  const getSenderBadge = (senderType: string) => {
    switch (senderType) {
      ...
      case 'support':
        return { bg: 'bg-purple-600', text: 'text-white', label: 'Support' }
      case 'host':
      case 'admin_as_host':
        return { bg: 'bg-blue-600', text: 'text-white', label: 'Host' }
      default:
        return { bg: 'bg-green-600', text: 'text-white', label: 'You' }
    }
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              When you book a car, you'll be able to message the host and support team here.
            </p>
            <button
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {conversation.lastMessage && (
                      <p className="text-sm text-gray-600 dark:text-gray-400 truncate">
                        {conversation.lastMessage.senderType === 'guest' ? 'You: ' : `${conversation.lastMessage.senderName}: `}
