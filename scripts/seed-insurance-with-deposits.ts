...
const DRY_RUN = false // CHANGED TO FALSE - WILL MAKE ACTUAL UPDATES
...
async function seedInsuranceWithDeposits() {
  try {
    ...
    for (const booking of bookings) {
      ...
      // Show progress every 20 bookings
      if (updateCount % 20 === 0) {
    ...
    console.log('\n' + '='.repeat(60))
    console.log('📈 FINAL DEPOSIT SUMMARY BY CAR CLASS:')
    console.log('='.repeat(60))
    ...
    console.log('\n' + '='.repeat(60))
    console.log(`✅ SEEDING COMPLETE - Updated ${updateCount} bookings with proper deposit amounts`)
    console.log('='.repeat(60))
