          ...
          <div className="flex-1 overflow-x-auto">
            <div className="flex">
              ...
              >
                ...
                <span className="text-xs font-medium">{t('airports')}</span>
              </a>
              <Link
                href="/rentals"
                className="flex items-center space-x-1.5 px-4 py-3 text-gray-600 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors whitespace-nowrap border-r border-gray-200 dark:border-gray-800 min-w-fit"
              >
                ...
                <span className="text-xs font-medium">{t('browseCars')}</span>
              </Link>
              <Link
                href="/rentals"
              ...
              <div className="lg:col-span-2">
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 sm:p-8">
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
                    {t('serviceArea', { city: currentCity.name })}
                  </h2>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-center">
                      ...
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('availableCars')}</div>
                    </div>
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-amber-600">{currentCity.stats.hosts}</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('localHosts')}</div>
                    </div>
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-amber-600">{currentCity.stats.avgRate}</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('avgDailyRate')}</div>
                    </div>
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-amber-600">{currentCity.stats.coverage}</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('coverage')}</div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-4">
                      {t('popularCars', { city: currentCity.name })}
                    </h3>
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{t('localCars')}</p>
                        <p className="text-xs text-gray-600 dark:text-gray-400">{t('localCarsDesc')}</p>
                      </div>
                    </li>
                    <li className="flex items-start space-x-3">
                      <IoSparklesOutline className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{t('millionInsurance')}</p>
                        <p className="text-xs text-gray-600 dark:text-gray-400">{t('millionInsuranceDesc')}</p>
                      </div>
                    </li>
                    <li className="flex items-start space-x-3">
                      <IoAirplaneOutline className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{t('airportDelivery')}</p>
                        <p className="text-xs text-gray-600 dark:text-gray-400">{t('airportDeliveryDesc')}</p>
                      </div>
                    </li>
                    <li className="flex items-start space-x-3">
                      <IoTimeOutline className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{t('flexiblePickup')}</p>
                        <p className="text-xs text-gray-600 dark:text-gray-400">{t('flexiblePickupDesc')}</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 border border-amber-200 dark:border-amber-800">
                  <h3 className="font-semibold text-amber-900 dark:text-amber-300 mb-3">
                    {t('findCarsIn', { city: currentCity.name })}
                  </h3>
                  <p className="text-sm text-amber-800 dark:text-amber-400 mb-4">
                    {t('browsePlusCars', { count: currentCity.stats.cars })}
                  </p>
