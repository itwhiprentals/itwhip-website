// app/(guest)/rentals/daily/page.tsx
...
const useCaseData = getUseCaseBySlug('daily')!
...
export async function generateMetadata({
  ...
  return {
    title: t('rentalsDailyTitle'),
    description: t('rentalsDailyDescription'),
    openGraph: {
      title: t('rentalsDailyOgTitle'),
      description: t('rentalsDailyOgDescription'),
      url: 'https://itwhip.com/rentals/daily',
      type: 'website',
    },
    alternates: {
      canonical: 'https://itwhip.com/rentals/daily',
    },
  }
}
