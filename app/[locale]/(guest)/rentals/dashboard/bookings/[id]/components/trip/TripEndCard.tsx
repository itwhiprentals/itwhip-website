...
import GuestReviewModal from '@/app/[locale]/(guest)/rentals/components/review/GuestReviewModal'
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-gray-600 to-gray-700 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-white">{t('tripCompleted')}</h3>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <h4 className="text-sm font-medium text-gray-900 mb-3">{t('tripSummary')}</h4>
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-gray-900">{totalMiles} {t('miles')}</span>
            </div>
            {booking.fuelLevelStart && booking.fuelLevelEnd && (
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">{t('fuelLevel')}</span>
        ...
        {charges && charges.total > 0 && (
          <div className="border border-amber-200 bg-amber-50 rounded-lg p-4">
            <h4 className="text-sm font-medium text-amber-900 mb-3">{t('additionalCharges')}</h4>
            <div className="space-y-2">
              ...
              <div className="pt-2 border-t border-amber-200">
                <div className="flex justify-between">
                  <span className="font-medium text-amber-900">{t('total')}</span>
            ...
            {disputeStatus && (
              <div className="mt-3 pt-3 border-t border-amber-200">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-amber-800">{t('disputeStatus')}</span>
        ...
        {(!charges || charges.total === 0) && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-green-900">{t('noAdditionalCharges')}</p>
                <p className="text-sm text-green-800 mt-1">
                  {t('noExtraFeesMessage')}
                </p>
              </div>
            </div>
          </div>
