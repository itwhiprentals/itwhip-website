            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {yearEstablished && (
                <>
                  ...
                  <span>{t('established', { year: yearEstablished })}</span>
                </>
              )}
            </div>
      ...
      {bio && (
        <div className="border-t border-gray-200 dark:border-gray-700 pt-5 mb-5">
          <h4 className="text-base font-medium text-gray-900 dark:text-white mb-3">
            {t('aboutPartner', { name: companyName })}
          </h4>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h5 className="text-sm font-semibold text-gray-900 dark:text-white mb-1">
                {t('threePlusDayMinRental')}
              </h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t('rideshareOptimized')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {supportPhone && (
              ...
              >
                ...
                <span>{supportPhone.replace(/^\+\s*\+/, '+')}</span>
              </a>
            )}
          </div>
          ...
          {partnerSlug && (
            ...
            >
              ...
              <span>{t('viewFullFleet', { count: fleetSize })}</span>
