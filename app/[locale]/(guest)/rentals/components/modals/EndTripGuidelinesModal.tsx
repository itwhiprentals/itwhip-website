...
export default function EndTripGuidelinesModal({ 
  ...
  const t = useTranslations('EndTripGuidelines')
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {activeTab === 'standard' && (
            <div className="space-y-6">
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('standardReturnProcess')}</h3>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 flex-1">
                        <h4 className="text-sm font-semibold text-gray-900">{t('step1Title')}</h4>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 flex-1">
                        <h4 className="text-sm font-semibold text-gray-900">{t('step2Title')}</h4>
                        <p className="text-xs text-gray-600 mt-1">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 flex-1">
                        <h4 className="text-sm font-semibold text-gray-900">{t('step5Title')}</h4>
                        <p className="text-xs text-gray-600 mt-1">
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('requiredPhotos')}</h3>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('frontOfVehicle')}</span>
                    </div>
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('backOfVehicle')}</span>
                    </div>
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('driversSide')}</span>
                    </div>
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('passengersSide')}</span>
                    </div>
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('interiorFront')}</span>
                    </div>
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('interiorBack')}</span>
                    </div>
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('odometerReading')}</span>
                    </div>
                    <div className="flex items-center">
                      <Camera className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-xs text-gray-700">{t('fuelGauge')}</span>
                    </div>
                  </div>
                </div>
              </section>
              ...
              {/* Important Reminders */}
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('beforeYouLeave')}</h3>
          ...
          {activeTab === 'early' && (
            <div className="space-y-6">
              ...
              <section>
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-red-900 mb-2">{t('earlyReturnPolicy')}</h4>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('earlyReturnProcess')}</h3>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('financialImplications')}</h3>
              ...
              {/* Alternative Options */}
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('considerAlternatives')}</h3>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          {activeTab === 'emergency' && (
            <div className="space-y-6">
              ...
              {/* Accident Protocol */}
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('ifInAccident')}</h3>
              ...
              {/* Vehicle Issues */}
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('vehicleBreakdown')}</h3>
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  <ul className="space-y-2 text-xs text-amber-800">
                    <li className="flex items-start">
              ...
              {/* Emergency Contacts */}
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-3">{t('emergencyContacts')}</h3>
                <div className="bg-gray-100 border border-gray-200 rounded-lg p-4">
                  <div className="space-y-3">
                    <div>
              ...
              <section>
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <div className="flex items-start">
                    <AlertCircle className="w-5 h-5 text-red-600 mr-2 flex-shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-red-900 mb-2">{t('vehicleAbandonment')}</h4>
                      <p className="text-xs text-red-800">
