...
export default function VerifyPage() {
  ...
  const t = useTranslations('VerifyBooking')
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">{t('loadingVerification')}</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            {t('bookingNumber', { code: booking.bookingCode })}
          </p>
        </div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 dark:text-white font-medium">
                    {t('totalAmount', { amount: booking.totalAmount.toFixed(2) })}
                  </span>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-green-900 dark:text-green-100">
                        {t('documentsSubmittedSuccessfully')}
                      </h3>
                      <p className="text-green-700 dark:text-green-300 mt-1">
                        {t('documentsReviewMessage')}
                      </p>
                    </div>
                  </div>
                </div>
