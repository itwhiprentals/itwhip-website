// app/[locale]/(guest)/rentals/weekly/page.tsx
...
const useCaseData = getUseCaseBySlug('weekly')!
...
export async function generateMetadata({
  ...
  return {
    title: t('rentalsWeeklyTitle'),
    description: t('rentalsWeeklyDescription'),
    openGraph: {
      title: t('rentalsWeeklyTitle'),
      description: t('rentalsWeeklyDescription'),
      url: 'https://itwhip.com/rentals/weekly',
      type: 'website'
    },
    alternates: {
      canonical: 'https://itwhip.com/rentals/weekly',
    },
  }
}
