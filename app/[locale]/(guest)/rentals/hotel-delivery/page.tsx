// app/(guest)/rentals/hotel-delivery/page.tsx
...
const useCaseData = getUseCaseBySlug('hotel-delivery')!
...
export async function generateMetadata({
  ...
  return {
    title: t('rentalsHotelDeliveryTitle'),
    description: t('rentalsHotelDeliveryDescription'),
    openGraph: {
      title: t('rentalsHotelDeliveryTitle'),
      description: t('rentalsHotelDeliveryDescription'),
      url: 'https://itwhip.com/rentals/hotel-delivery',
      type: 'website'
    },
    alternates: {
      canonical: 'https://itwhip.com/rentals/hotel-delivery',
    },
  }
}
