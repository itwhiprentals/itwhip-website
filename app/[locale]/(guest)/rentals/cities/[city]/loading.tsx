// app/rentals/cities/[city]/loading.tsx
// Loading state for individual city page
...
export default function CityPageLoading() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="pt-16">
        {/* Hero skeleton */}
        <div className="relative h-64 md:h-80 bg-gray-800 animate-pulse">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center space-y-3 px-4">
              <div className="h-8 w-48 bg-gray-700 rounded-lg mx-auto" />
              <div className="h-5 w-64 bg-gray-700 rounded mx-auto" />
            </div>
          </div>
        </div>
