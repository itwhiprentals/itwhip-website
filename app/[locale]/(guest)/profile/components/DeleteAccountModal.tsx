// app/(guest)/profile/components/DeleteAccountModal.tsx
'use client'
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    ...
                    <span className="text-sm text-gray-700 dark:text-gray-300">{t('deleteProfile')}</span>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <IoCarOutline className="w-4 h-4 text-gray-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">{t('deleteBookings')}</span>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <IoCardOutline className="w-4 h-4 text-gray-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">{t('deletePayments')}</span>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <IoDocumentTextOutline className="w-4 h-4 text-gray-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">{t('deleteDocuments')}</span>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  {DELETION_REASON_KEYS.map((key) => {
                    const labelMap: Record<string, string> = {
                      no_longer_need: t('reasonNoLongerNeed'),
                      privacy_concerns: t('reasonPrivacy'),
                      found_alternative: t('reasonAlternative'),
                      too_expensive: t('reasonExpensive'),
                      poor_experience: t('reasonPoorExperience'),
                      other: t('reasonOther')
                    }
                    return (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 dark:text-red-400">
                      {t('confirmDeletionDesc', { email: userEmail })}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center py-6">
              ...
              <div className="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg text-left">
                <p className="text-sm text-blue-700 dark:text-blue-300">
                  <strong>{t('changedYourMind')}</strong> {t('changedYourMindDesc')}
                </p>
              </div>
            </div>
          )}
