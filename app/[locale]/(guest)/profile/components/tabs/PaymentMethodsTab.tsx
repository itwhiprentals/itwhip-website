...
export default function PaymentMethodsTab() {
  const t = useTranslations('PaymentTab')
    ...
    return (
      <div className="flex items-center justify-center py-8">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">{t('loadingWallet')}</p>
        </div>
      </div>
    )
  }
  ...
  const sections = [
    {
      ...
      value: data?.paymentMethodCount === 0 ? t('noCards') : t('cardCount', { count: data?.paymentMethodCount || 0 })
    },
    {
      ...
      title: t('depositWallet'),
      description: t('preloadFunds'),
    ...
    },
    {
      ...
      title: t('creditsBonus'),
      description: t('viewCredits'),
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-4">
        <h2 className="text-base font-semibold text-gray-900 dark:text-white">{t('paymentsWallet')}</h2>
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center">
          ...
          <p className="text-[10px] text-gray-500 dark:text-gray-400">{t('cards')}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center">
          ...
          <p className="text-[10px] text-gray-500 dark:text-gray-400">{t('deposit')}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center">
          ...
          <p className="text-[10px] text-gray-500 dark:text-gray-400">{t('credits')}</p>
        </div>
      </div>
