...
export default function ReviewsTab() {
  ...
  const t = useTranslations('ReviewsProfileTab')
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">{t('loadingReviews')}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      ...
      <div className="mb-5 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">{t('tripReviews')}</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          {t('completeReviewHistory')}
        </p>
      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3">
                        <div className="flex items-center gap-1.5 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <span className="truncate">
                            {new Date(review.tripStartDate).toLocaleDateString(locale, {
                              month: 'short',
                              day: 'numeric'
                            })} - {new Date(review.tripEndDate).toLocaleDateString(locale, {
                              month: 'short',
                              day: 'numeric',
                              year: 'numeric'
                            })}
                        ...
                        <div className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400">
                          ...
                          <span className="font-medium">{getTimeAgo(review.tripEndDate, t)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-green-900 dark:text-green-300 uppercase tracking-wide truncate">
                          {t('hostReview', { hostName: review.hostName })}
                        </span>
                      </div>
                      <div className="flex-shrink-0">
