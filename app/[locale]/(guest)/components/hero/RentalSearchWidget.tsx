  ...
  useEffect(() => {
    if (searchParams.pickupDate && searchParams.returnDate) {
      ...
      if (returnDateTime <= pickupDateTime) {
        setDateError(t('returnAfterPickup'))
      } else {
        setDateError('')
      }
    }
                    ...
                    <div className="flex items-center justify-between px-2 h-full
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <div className="text-left">
                          <p className="text-[9px] text-gray-500 dark:text-gray-400 leading-none">{t('pickup')}</p>
                  ...
                  >
                    <div className={`flex items-center justify-between px-2 h-full
                      ...
                      <div className="flex items-center gap-1.5">
                        <IoCalendarOutline className="w-3.5 h-3.5 text-gray-400 flex-shrink-0" />
                        <div className="text-left">
                          <p className="text-[9px] text-gray-500 dark:text-gray-400 leading-none">{t('return')}</p>
                          <p className="text-[12px] font-semibold text-gray-900 dark:text-white leading-tight mt-0.5">
