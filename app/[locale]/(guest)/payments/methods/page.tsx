  ...
  return (
    <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    {t('expires', { month: method.expMonth.toString().padStart(2, '0'), year: method.expYear })}
                  </p>
                </div>
      ...
      {showAddCard ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-semibold text-gray-900 dark:text-white">{t('addNewCard')}</h3>
            <button
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="space-y-1 text-xs text-blue-800 dark:text-blue-300">
              <li>{t('aboutDefaultCard')}</li>
              <li>{t('aboutAcceptedCards')}</li>
              <li>{t('aboutDeposits')}</li>
              <li>{t('aboutSecure')}</li>
            </ul>
          </div>
        </div>
      ...
      <div className="text-center">
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">{t('weAccept')}</p>
