...
// Rideshare-specific benefits - Using key-based pattern for i18n
const rideshareBenefits = [
  {
    icon: IoLeafOutline,
    titleKey: 'benefitFuelEfficiencyTitle' as const,
    descKey: 'benefitFuelEfficiencyDesc' as const,
    statKey: 'benefitFuelEfficiencyStat' as const,
  },
  {
    icon: IoSpeedometerOutline,
    titleKey: 'benefitReliabilityTitle' as const,
    descKey: 'benefitReliabilityDesc' as const,
    statKey: 'benefitReliabilityStat' as const,
  },
  {
    icon: IoShieldCheckmarkOutline,
    titleKey: 'benefitApprovedTitle' as const,
    descKey: 'benefitApprovedDesc' as const,
    statKey: 'benefitApprovedStat' as const,
  },
  {
    icon: IoConstructOutline,
    titleKey: 'benefitMaintenanceTitle' as const,
    descKey: 'benefitMaintenanceDesc' as const,
    statKey: 'benefitMaintenanceStat' as const,
  },
  {
    icon: IoCashOutline,
    titleKey: 'benefitRatesTitle' as const,
    descKey: 'benefitRatesDesc' as const,
    statKey: 'benefitRatesStat' as const,
  },
  {
    icon: IoFlashOutline,
    titleKey: 'benefitSameDayTitle' as const,
    descKey: 'benefitSameDayDesc' as const,
    statKey: 'benefitSameDayStat' as const,
  }
]

// How it works steps - Using key-based pattern for i18n
...
// Lifestyle images with overlay text - Using key-based pattern for i18n
const lifestyleImages = [
  {
    src: '/rideshare/lifestyle-sunset.jpg',
    alt: 'Driver at sunset',
    titleKey: 'lifestyleConfidenceTitle' as const,
    subtitleKey: 'lifestyleConfidenceSubtitle' as const,
  },
  {
    src: '/rideshare/lifestyle-navigation.jpg',
    alt: 'Rideshare navigation',
    titleKey: 'lifestyleEarningsTitle' as const,
    subtitleKey: 'lifestyleEarningsSubtitle' as const,
  },
  {
    src: '/rideshare/lifestyle-fleet.jpg',
    alt: 'Fleet lineup',
    titleKey: 'lifestyleFleetTitle' as const,
    subtitleKey: 'lifestyleFleetSubtitle' as const,
  }
]
...
export default async function RidesharePage() {
  const t = await getTranslations('Rideshare')
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 -mt-8 sm:-mt-10 md:-mt-12">
            <div className="text-center mb-4 sm:mb-5">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
                &bull; {t('heroSubtitle')} &bull; {t('heroInsurance')} &bull;
              </p>
            </div>
            ...
            <section className="py-5 bg-white dark:bg-gray-800">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">
                        {t('itwhipRideshareVehicles')}
                      </h2>
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        {t('platformVehicleCount', { count: platformData.totalCount })}
                      </p>
                    </div>
                  </div>
                  <Link
                  ...
                  >
                    {t('viewFleet')} <IoArrowForwardOutline className="w-4 h-4" />
                  </Link>
                </div>
                ...
                <div className="mt-4 text-center sm:hidden">
                  ...
                  >
                    {t('viewAllItwhipVehicles')} <IoArrowForwardOutline className="w-5 h-5" />
                  </Link>
                </div>
              </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-5">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mt-2">
                  {t('partnerFleetRentals')}
                </h2>
                <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm">
                  {t('partnerFleetSubtitle')}
                </p>
              </div>
