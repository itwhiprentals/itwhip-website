...
interface PageProps {
  params: Promise<{ locale: string; partnerSlug: string }>
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const { locale, partnerSlug } = await params
  ...
  return {
    ...
    alternates: {
      canonical: getCanonicalUrl(`/rideshare/${partnerSlug}`, locale),
      languages: getAlternateLanguages(`/rideshare/${partnerSlug}`),
    }
  }
}
