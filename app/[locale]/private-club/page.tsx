...
export default function PrivateClubPage() {
  const t = useTranslations('PrivateClub')
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto mb-6">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">{t('hiddenFees')}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">48hr</div>
                  <div className="text-xs text-gray-600 dark:text-gray-400">{t('claimsResolution')}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">100%</div>
                  <div className="text-xs text-gray-600 dark:text-gray-400">{t('transparent')}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-6 max-w-2xl mx-auto mb-8">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <div className="text-xs text-purple-200">{t('hiddenFees')}</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-white">$0</div>
                  <div className="text-xs text-purple-200">{t('surgePricing')}</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-white">100%</div>
                  <div className="text-xs text-purple-200">{t('transparent')}</div>
                </div>
              </div>
            </div>
