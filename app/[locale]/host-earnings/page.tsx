          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-3">
                {t('earningsByTierTitle')}
              </h2>
              <p className="text-gray-600 dark:text-gray-400">
                {t('earningsByTierDesc')}
              </p>
            </div>
                ...
                >
                  ...
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between">
                      <span className="text-gray-500">{t('deductible')}:</span>
                      <span className="font-medium">{tier.deductible}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">{t('liability')}:</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                {t('selectVehicleCategory')}
              </h2>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t('personalizedEstimates')}
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  {t('paymentInstantDesc')}
                </p>
                <div className="text-xs text-purple-600 font-semibold">
                  {t('paymentInstantAvail')}
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  {t('paymentGuaranteedDesc')}
                </p>
                <div className="text-xs text-purple-600 font-semibold">
                  {t('paymentGuaranteedNote')}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full mb-4">
                ...
                <span className="text-sm font-medium">{t('fleetOwnerProgram')}</span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-3">
                {t('scaleBusinessTitle')}
              </h2>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg p-6 text-white">
              <h3 className="text-lg font-semibold mb-4 text-center">{t('fleetSuccessMetrics')}</h3>
