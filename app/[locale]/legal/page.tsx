          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                Last Updated: {t('lastUpdated')} • {t('governedBy')}
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 sm:p-6">
              ...
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 space-y-1">
                ...
                <p>Support Response Time: {t('contactResponseTime')}</p>
                <p>Business Hours: {t('contactBusinessHours')}</p>
                <p>Emergency: {t('emergencyNotice')}</p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <Link href="/privacy" className="text-amber-600 hover:text-amber-700 font-medium text-xs sm:text-sm">
                  {t('privacyLink')}
                </Link>
                <Link href="/insurance" className="text-amber-600 hover:text-amber-700 font-medium text-xs sm:text-sm">
                  {t('insuranceLink')}
                </Link>
