...
function VerifyEmailContent() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (data.requiresPhoneVerification && data.phone) {
        setRedirectMessage(t('redirectingToPhone'))
        setSuccess(true)
        ...
        setRedirectMessage(t('redirectingToDashboard'))
        setSuccess(true)
  ...
  const [redirectMessage, setRedirectMessage] = useState(t('redirectingToDashboard'))
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
            {t('emailCodeSent', { email: maskEmail(email) })}
          </p>
