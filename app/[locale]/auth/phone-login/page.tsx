    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-xl p-8 border border-gray-700">
          <h2 className="text-2xl font-bold text-white mb-4">{t('completeYourAccount')}</h2>
          <p className="text-gray-400 mb-6">
            {t('completeAccountDesc')}
          </p>
          ...
          <form onSubmit={(e) => handleEmailSubmit(e, false)} className="space-y-4">
            ...
            >
              {isSubmittingEmail ? (
                ...
                <span>{t('verifyEmailContinue')}</span>
              )}
            </button>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              {codeSent
                ? t('enterCode', { phone: formatPhoneDisplay(phone) })
                : mode === 'signup'
                  ? t('phoneEnterToCreate')
                  : t('phoneEnterToSignIn')
              }
            </p>
          </div>
