...
import CrisisHeader from '@/app/components/hotel-solutions/CrisisHeader'
import LiveEventStreams from '@/app/components/hotel-solutions/LiveEventStreams'
import FourDisasters from '@/app/components/hotel-solutions/FourDisasters'
import InstantRideSection from '@/app/components/hotel-solutions/InstantRideSection'
import PlatformPreview from '@/app/components/hotel-solutions/PlatformPreview'
import ROICalculator from '@/app/components/hotel-solutions/ROICalculator'
import TabbedComparison from '@/app/components/hotel-solutions/TabbedComparison'
import StrategicHonesty from '@/app/components/hotel-solutions/StrategicHonesty'
import ObjectionCrusher from '@/app/components/hotel-solutions/ObjectionCrusher'
import LiveProofWidgets from '@/app/components/hotel-solutions/LiveProofWidgets'
...
export default function HotelSolutionsEnhanced() {
  const t = useTranslations('HotelSolutions')
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 text-blue-800 dark:text-blue-400 px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-4 sm:mb-6 border border-blue-300 dark:border-blue-800">
              ...
              <span className="text-xs sm:text-sm font-bold uppercase tracking-wider">{t('zeroSetupTime')}</span>
            </div>
            
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-900 dark:text-white mb-3 sm:mb-4">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">{t('fifteenMinute')}</span> {t('integration')}
            </h2>
  ...
  "data": {
    ...
    "eta": "0 seconds"
          ...
          <div className="mt-6 sm:mt-8 text-center">
            ...
            >
              <span>{t('seeAllIntegrations')}</span>
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950/20 dark:to-green-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-900 dark:text-white mb-3 sm:mb-4">
              {t('automated')} <span className="text-green-600">{t('esgCompliance')}</span>
            </h2>
            <p className="text-base sm:text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto px-2">
