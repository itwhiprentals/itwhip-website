...
// Cycling options for each category (demo animation data - not translated)
...
export function ChoeTripPlanner() {
  ...
  const tripFeatures = [
    { icon: IoAirplaneOutline, labelKey: 'tripFeature1Label' as const, descKey: 'tripFeature1Desc' as const },
    { icon: IoBedOutline, labelKey: 'tripFeature2Label' as const, descKey: 'tripFeature2Desc' as const },
    { icon: IoCarSportOutline, labelKey: 'tripFeature3Label' as const, descKey: 'tripFeature3Desc' as const },
    { icon: IoRestaurantOutline, labelKey: 'tripFeature4Label' as const, descKey: 'tripFeature4Desc' as const },
    { icon: IoCloudyOutline, labelKey: 'tripFeature5Label' as const, descKey: 'tripFeature5Desc' as const },
    { icon: IoNavigateOutline, labelKey: 'tripFeature6Label' as const, descKey: 'tripFeature6Desc' as const }
  ]
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-[#a8a8a8] max-w-2xl mx-auto">
            {t.rich('tripPlannerSubtitle', { highlight: (chunks) => <span className="font-semibold text-[#e87040]">{t('tripPlannerHighlight')}</span> })}
          </p>
        </div>
        ...
        <div className={`rounded-lg border overflow-hidden mb-8 shadow-lg transition-colors ${
          ...
          <div className={`flex items-center gap-2 px-4 py-3 border-b transition-colors ${
            ...
            >
              ...
              <span className="hidden sm:inline">{t('tripPlannerReplay')}</span>
            </button>
          </div>
          ...
          <div className="p-5 sm:p-6 font-mono text-sm min-h-[320px]">
            ...
            {showThinking && (
              <div className="flex items-center gap-2 text-[#d4a574] mb-4">
                ...
                <span>{t('tripPlannerThinking')}{thinkingDots}</span>
              </div>
            )}
            ...
            {showSuccess && (
              <div className="border-l-2 border-[#e87040] pl-4 space-y-3">
                <div className="text-[#27ca3f] flex items-center gap-2">
                  <span>&#x2713;</span>
                  <span>{t('tripPlannerGenerated')}</span>
                </div>
                ...
                <div className={`space-y-2.5 ${isDarkTerminal ? 'text-[#a8a8a8]' : 'text-gray-600'}`}>
                  ...
                  {currentStep >= 0 && (
                    <div className="flex items-center gap-3 animate-fadeIn">
                      ...
                      <span>
                        <span className={`font-medium ${isDarkTerminal ? 'text-white' : 'text-gray-900'}`}>{t('tripPlannerFlights')}</span>{' '}
                  ...
                  {currentStep >= 1 && (
                    <div className="flex items-center gap-3 animate-fadeIn">
                      ...
                      <span>
                        <span className={`font-medium ${isDarkTerminal ? 'text-white' : 'text-gray-900'}`}>{t('tripPlannerHotel')}</span>{' '}
                  ...
                  {currentStep >= 2 && (
                    <div className="flex items-center gap-3 animate-fadeIn">
                      ...
                      <span>
                        <span className={`font-medium ${isDarkTerminal ? 'text-white' : 'text-gray-900'}`}>{t('tripPlannerCars')}</span>{' '}
                  ...
                  {currentStep >= 3 && (
                    <div className="flex items-center gap-3 animate-fadeIn">
                      ...
                      <span>
                        <span className={`font-medium ${isDarkTerminal ? 'text-white' : 'text-gray-900'}`}>{t('tripPlannerDinner')}</span>{' '}
                  ...
                  {currentStep >= 4 && (
                    <div className="flex items-center gap-3 animate-fadeIn">
                      ...
                      <span><span className={`font-medium ${isDarkTerminal ? 'text-white' : 'text-gray-900'}`}>{t('tripPlannerWeather')}</span> {t('tripPlannerWeatherValue')}</span>
                    </div>
                  )}
                  ...
                  {currentStep >= 5 && (
                    <div className="flex items-center gap-3 animate-fadeIn">
                      ...
                      <span><span className={`font-medium ${isDarkTerminal ? 'text-white' : 'text-gray-900'}`}>{t('tripPlannerTip')}</span> {t('tripPlannerTipValue')}</span>
                    </div>
                  )}
                </div>
                ...
                {showReady && (
                  <div className={`pt-2 animate-fadeIn ${isDarkTerminal ? 'text-[#666]' : 'text-gray-500'}`}>
                    <span className="text-[#27ca3f]">{t('tripPlannerReady')}</span> {t.rich('tripPlannerConfirm', { confirm: (chunks) => <span className={`font-medium ${isDarkTerminal ? 'text-white' : 'text-gray-900'}`}>{t('tripPlannerConfirmWord')}</span> })}
                  </div>
                )}
              </div>
            )}
