  ...
  const screenshots = [
    {
      ...
      titleKey: 'showcaseScreen1Title' as const,
      descKey: 'showcaseScreen1Desc' as const
    },
    {
      src: '/images/choe-showcase/choe-search-results.png',
      alt: 'Choé AI search results - car listings',
      titleKey: 'showcaseScreen2Title' as const,
      descKey: 'showcaseScreen2Desc' as const
    },
    {
      src: '/images/choe-showcase/choe-pricing.png',
      alt: 'Choé AI pricing breakdown - transparent costs',
      titleKey: 'showcaseScreen3Title' as const,
      descKey: 'showcaseScreen3Desc' as const
    },
    {
      src: '/images/choe-showcase/choe-booking.png',
      alt: 'Choé AI booking confirmation - easy checkout',
      titleKey: 'showcaseScreen4Title' as const,
      descKey: 'showcaseScreen4Desc' as const
    }
  ]
