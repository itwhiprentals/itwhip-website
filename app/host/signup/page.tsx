            ...
            <div className="flex items-center">
              ...
              <div className="flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold transition-all ${
                  currentStep >= 1 ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
                }`}>
                  {currentStep > 1 ? '✓' : '1'}
                </div>
              ...
              <div className="flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold transition-all ${
                  currentStep >= 2 ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
                }`}>
              ...
              {formData.hostRole !== 'manage' && (
                <>
                  ...
                  <div className="flex flex-col items-center">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold transition-all ${
                      currentStep >= 3 ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
                    }`}>
                      3
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-colors"
                            placeholder="Doe"
                            required
                          />
                        </div>
                ...
                <div className="space-y-4 lg:space-y-6">
                        ...
                        <label
                          className={`flex items-start gap-3 p-3 lg:p-4 rounded-lg cursor-pointer transition border-2 ${
                            formData.hostRole === 'own'
                              ...
                              : 'bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-transparent hover:border-green-300 dark:hover:border-gray-600'
                          }`}
                        >
                          <input
                            type="radio"
                        ...
                        <label
                          className={`flex items-start gap-3 p-3 lg:p-4 rounded-lg cursor-pointer transition border-2 ${
                            formData.hostRole === 'manage'
                              ...
                              : 'bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-transparent hover:border-purple-300 dark:hover:border-gray-600'
                          }`}
                        >
                          <input
                            type="radio"
                        ...
                        <label
                          className={`flex items-start gap-3 p-3 lg:p-4 rounded-lg cursor-pointer transition border-2 ${
                            formData.hostRole === 'both'
                              ...
                              : 'bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-transparent hover:border-indigo-300 dark:hover:border-gray-600'
                          }`}
                        >
                          <input
                            type="radio"
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className={`${isOAuthUser && formData.hostRole !== 'manage' ? 'w-full' : 'flex-1'} py-3 px-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-medium rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed`}
                    >
                      {formData.hostRole === 'manage' ? (
                        isLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <label className={`block w-full border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors ${
                    uploadingPhotos
                      ...
                      : 'border-green-500 hover:border-green-400 hover:bg-green-50 dark:hover:bg-green-900/20'
                  }`}>
                    <input
                      type="file"
                      accept="image/*"
                  ...
                  {vehiclePhotos.length > 0 && (
                    <div className="grid grid-cols-2 gap-3 mt-4">
                      {vehiclePhotos.map((photo, index) => (
                        <div key={index} className="relative group aspect-video rounded-lg overflow-hidden bg-gray-200 dark:bg-gray-700">
                          <Image
                            src={photo.url}
