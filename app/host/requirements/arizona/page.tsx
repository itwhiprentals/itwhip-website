      ...
      <section className="bg-gradient-to-br from-orange-700 via-red-600 to-orange-700 text-white pt-20 sm:pt-24 pb-12 sm:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-orange-500/30 rounded-full text-orange-200 text-sm font-medium mb-4">
            ...
            <p className="text-lg sm:text-xl text-orange-100 leading-relaxed">
              {t('heroDescription')}
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t('eligibleVehiclesTitle')}</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t('notEligibleTitle')}</h3>
              <ul className="space-y-3">
                {[
                  t('notEligibleItem0'),
                  t('notEligibleItem1'),
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="p-5 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-3">{category.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">{t('insuranceRequirementsTitle')}</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 leading-relaxed">
                  {t('insuranceRequirementsDescription')}
                </p>
                <ul className="space-y-2">
                  {[
                    t('insuranceCoverageItem0'),
                    t('insuranceCoverageItem1'),
                    t('insuranceCoverageItem2')
                  ].map((item, i) => (
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">{t('emissionsTestingTitle')}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    {t('emissionsTestingDescription')}
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">{t('registrationTitle')}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
