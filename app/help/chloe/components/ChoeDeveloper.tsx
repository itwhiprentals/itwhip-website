...
export function ChoeDeveloper() {
  return (
    <section className="py-10 sm:py-14 bg-white dark:bg-[#0f0f0f] relative border-t border-gray-200 dark:border-[#222]">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-lg bg-gray-100 dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333] text-gray-600 dark:text-[#a8a8a8] text-xs font-mono uppercase tracking-wider mb-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-10">
          {products.map((product, index) => (
            <div
              key={product.name}
              className="group bg-white dark:bg-[#1a1a1a] rounded-lg p-4 sm:p-5 border border-gray-200 dark:border-[#333] hover:border-[#e87040]/40 transition-all choe-animate-in"
        ...
        <div className="bg-white dark:bg-[#1a1a1a] rounded-lg overflow-hidden border border-gray-200 dark:border-[#333] mb-10">
          {/* Terminal header */}
          <div className="flex items-center gap-2 px-4 py-3 bg-gray-100 dark:bg-[#252525] border-b border-gray-200 dark:border-[#333]">
                ...
                <div
                  ...
                  className={`rounded-lg p-4 text-center transition-all ${
                    tier.highlight
                      ...
                      : 'bg-gray-100 dark:bg-[#252525] border border-gray-200 dark:border-[#333] hover:border-[#e87040]/30'
                  }`}
                >
