...
export const CITY_SEO_DATA: Record<string, CitySeoData> = {
  'phoenix': {
    ...
    name: 'Phoenix',
    type: 'city',
    metaTitle: 'Car Rentals in Phoenix, AZ | From $35/day | Local Owners, No Lines | ItWhip',
    metaDescription: 'Rent from local Phoenix car owners. SUVs from $55/day, sedans from $35/day, luxury from $99/day. Free airport delivery, instant booking, $1M insurance included.',
