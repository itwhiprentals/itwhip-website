...
export const vehicleSpecs: VehicleDatabase = {
  ...
  'Toyota': {
    ...
    'Prius': { trims: ['L Eco', 'LE', 'XLE', 'Limited'], seats: 5, doors: 4, transmission: 'cvt', carType: 'hatchback', fuelType: 'hybrid' },
    'Prius Prime': { trims: ['LE', 'XLE', 'Limited'], seats: 4, doors: 4, transmission: 'cvt', carType: 'hatchback', fuelType: 'plug-in hybrid' },
    'Prius Prime PHEV': { trims: ['LE', 'XLE', 'Limited'], seats: 4, doors: 4, transmission: 'cvt', carType: 'hatchback', fuelType: 'plug-in hybrid' },
