            ...
            <div className="flex space-x-6 min-w-max">
              ...
              <div className="flex items-center space-x-4">
                <div className="px-3 py-1 bg-green-100 dark:bg-green-900/30 rounded-lg">
                  <div className="text-xs text-gray-600 dark:text-gray-400">Your Surge</div>
                ...
                <div className="px-3 py-1 bg-red-100 dark:bg-red-900/30 rounded-lg">
                  <div className="text-xs text-gray-600 dark:text-gray-400">Uber Surge</div>
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">Saved Today</div>
                </div>
              </div>
        ...
        <div className="max-w-[1800px] mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-6">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
                  <div className="p-3 md:p-4 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                      <h2 className="text-base md:text-lg font-semibold text-gray-900 dark:text-white">Live Driver Map</h2>
              ...
              <div className="order-1 lg:order-2 space-y-4 lg:space-y-6">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow">
                  <div className="p-3 md:p-4 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-white">Ride Queue</h3>
                ...
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-lg shadow p-3 md:p-4 border border-amber-200 dark:border-amber-800">
                  <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-white mb-3">Fleet Performance</h3>
                  <div className="space-y-2 md:space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Acceptance Rate</span>
                      <span className="text-xs md:text-sm font-bold text-green-600">94%</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Avg Trip Time</span>
                      <span className="text-xs md:text-sm font-bold text-gray-900 dark:text-white">18 min</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Peak Hour Alert</span>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 dark:bg-gray-800 sticky top-0">
                    <tr>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400">Driver</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400">Vehicle</th>
                      <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 dark:text-gray-400">Status</th>
                      <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 dark:text-gray-400">Rating</th>
                      <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 dark:text-gray-400">Trips</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 dark:text-gray-400">Earnings</th>
                      <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 dark:text-gray-400">Response</th>
                      <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 dark:text-gray-400">Distance</th>
                      <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 dark:text-gray-400">Last Active</th>
          ...
          <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-3 md:p-4">
              <h4 className="text-xs md:text-sm font-semibold text-gray-900 dark:text-white mb-2 md:mb-3">Fleet Performance</h4>
              <div className="space-y-2 md:space-y-3">
                <div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg shadow p-3 md:p-4 border border-green-200 dark:border-green-800">
              <h4 className="text-xs md:text-sm font-semibold text-gray-900 dark:text-white mb-2 md:mb-3">Revenue Impact</h4>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg shadow p-3 md:p-4 border border-purple-200 dark:border-purple-800">
              <div className="flex items-center justify-between mb-2 md:mb-3">
                <h4 className="text-xs md:text-sm font-semibold text-gray-900 dark:text-white">AI Insights</h4>
