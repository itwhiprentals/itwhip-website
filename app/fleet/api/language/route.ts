...
const PAGE_NAMESPACE_MAP: Record<string, string[]> = {
  ...
  '/rentals/trip/start/[id]': ['TripStartCard'],
  '/rentals/trip/end/[id]': ['TripEnd', 'PaymentConfirm'],
  '/rentals/dashboard/bookings/[id]': ['BookingDetail', 'TripStartCard', 'TripActiveCard', 'EndTripConfirm', 'ModifyBooking'],
  ...
  '/partner/bookings': ['PartnerBookings', 'HandoffHost', 'PartnerNav'],
  '/partner/bookings/[id]': ['HandoffHost', 'PartnerNav'],
