    ...
    <div className="w-full">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 p-4 mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 xl:grid-cols-12 gap-3">
          ...
          {/* Push Notifications */}
          <Link
            href={`/fleet/notifications?key=${apiKey}`}
          ...
          >
            <IoNotificationsOutline className="text-2xl group-hover:scale-110 transition-transform" />
            <span className="text-xs font-medium text-center leading-tight">Push</span>
          </Link>
          ...
          {/* Language */}
          <Link
            href={`/fleet/language?key=${apiKey}`}
            className="min-h-[76px] px-3 py-3 bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-lg hover:from-emerald-600 hover:to-teal-700 transition-all shadow-md hover:shadow-lg flex flex-col items-center justify-center gap-1.5 group"
          >
