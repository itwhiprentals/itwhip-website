// app/fleet/analytics/components/BrowserDrilldown/BrowserTopPages.tsx
'use client'

interface BrowserTopPagesProps {
  data: { path: string; views: number }[]
}

export default function BrowserTopPages({ data }: BrowserTopPagesProps) {
  return (
    <div>
