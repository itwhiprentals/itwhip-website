    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-orange-200 font-medium">Fleet Partner Program</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-white text-orange-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-orange-50 transition-colors"
              >
                Apply Now
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {commissionTiers.map((tier, index) => (
              ...
              >
                {index === 3 && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-orange-800 text-white text-xs font-bold px-3 py-1 rounded-full">
                    BEST VALUE
                  </div>
                )}
                <div className={`text-sm font-medium mb-2 ${index === 3 ? 'text-orange-200' : 'text-gray-500 dark:text-gray-400'}`}>
                  {tier.tier}
                </div>
                <div className={`text-4xl font-bold mb-2 ${index === 3 ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                  {tier.rate}
                </div>
                <div className={`text-sm ${index === 3 ? 'text-orange-200' : 'text-gray-600 dark:text-gray-300'}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                <IoTimeOutline className="w-8 h-8 text-orange-600" />
                <div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">Average approval time</div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">24-48 hours</div>
                </div>
              </div>
              <div className="space-y-4 mb-8">
                <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-gray-600 dark:text-gray-300">Application Review</span>
                  <span className="font-medium text-gray-900 dark:text-white">Same Day</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-gray-600 dark:text-gray-300">Document Verification</span>
                  <span className="font-medium text-gray-900 dark:text-white">1-2 Business Days</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-gray-600 dark:text-gray-300">Account Activation</span>
                  <span className="font-medium text-gray-900 dark:text-white">Immediate</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600 dark:text-gray-300">First Vehicle Live</span>
                  <span className="font-medium text-gray-900 dark:text-white">Same Day</span>
                </div>
              </div>
              <Link
                href="/partners/apply/start"
                className="block w-full bg-orange-600 hover:bg-orange-700 text-white text-center py-4 rounded-lg font-semibold transition-colors"
              >
      ...
      <section className="py-16 bg-gradient-to-r from-gray-900 to-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <IoPeopleOutline className="w-16 h-16 text-orange-500 mx-auto mb-6" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/partners/apply/start"
              className="inline-flex items-center justify-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors"
            >
              Apply Now
              <IoArrowForward className="w-5 h-5" />
            </Link>
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 border-2 border-gray-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-700 transition-colors"
            >
              Schedule a Call
            </Link>
          </div>
