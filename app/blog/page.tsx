          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
                P2P Car Rental Insights
              </h1>
              <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 mb-6">
                Expert guides on peer-to-peer car sharing in Arizona. Learn how to earn up to 90% as a host, 
                understand insurance tiers, and discover the best rental options in Phoenix.
              </p>
        ...
        <section className="py-12 sm:py-16 bg-gradient-to-r from-purple-600 to-blue-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-purple-100 mb-8 max-w-2xl mx-auto">
              Join Arizona's premier peer-to-peer car sharing platform. List your vehicle and keep up to 90% of your earnings.
            </p>
