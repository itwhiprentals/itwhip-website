...
export default function CompactCarCard({ car, accentColor = 'amber' }: CompactCarCardProps) {
  ...
  return (
    <Link
      href={carUrl}
      className="group bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
    >
      {/* Image Container */}
