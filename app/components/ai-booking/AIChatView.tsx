  ...
  return (
    <div className="text-center py-8">
      <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
        <IoSparkles size={24} className="text-primary" />
      </div>
...
function ClaudeLogo() {
  return (
    <svg width="52" height="12" viewBox="0 0 690 148" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Official Claude logo — starburst icon + wordmark */}
      <g transform="translate(-75.96,-223.53)">
        {/* Starburst icon (Anthropic orange) */}
