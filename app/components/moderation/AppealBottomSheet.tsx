  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 md:inset-0 z-50 flex md:items-center md:justify-center pointer-events-none">
        <div className="bg-white dark:bg-gray-800 w-full md:max-w-3xl md:mx-auto rounded-t-2xl md:rounded-2xl shadow-2xl pointer-events-auto max-h-[70vh] md:max-h-[85vh] flex flex-col">
            ...
            {loading ? (
              ...
              <>
                {specificModeration ? (
                  <>
                    ...
                    {specificModeration.type === 'warning' && (
                      <div className="bg-white dark:bg-gray-700 border-2 border-yellow-400 dark:border-yellow-600 rounded-xl shadow-md overflow-hidden">
                        <div className="p-4 md:p-5">
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-2 border-orange-400 dark:border-orange-600 rounded-xl shadow-md overflow-hidden">
                        <div className="p-4 md:p-5">
                          ...
                          {moderationInfo.suspension.appealEligibility.reason === 'EXISTING_APPEAL' && (
                            <div className="mt-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-700 rounded-lg p-3">
                    ...
                    {moderationInfo.accountStatus === 'WARNED' && displayWarnings.length > 0 && (
                      <div className="space-y-3">
                        ...
                        {displayWarnings.map((warning) => (
                          <div
                            key={warning.id}
                            className="bg-white dark:bg-gray-700 border-2 border-yellow-400 dark:border-yellow-600 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow"
                          >
                            <div className="p-4 md:p-5">
                              <div className="flex items-start justify-between">
                                <div className="flex-1 min-w-0">
                                ...
                                <button
                                  ...
                                  className="ml-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                                >
                                  <ChevronDown 
                              ...
                              {warning.appealEligibility.canAppeal && (
                                <button
                                  ...
                                  className={`mt-4 w-full px-4 py-3 rounded-lg text-sm font-semibold transition-all shadow-sm ${
                                    selectedModerationId === warning.id
                                      ? 'bg-yellow-500 hover:bg-yellow-600 text-white shadow-md'
                                      : 'bg-white dark:bg-gray-600 text-yellow-700 dark:text-yellow-300 border-2 border-yellow-400 dark:border-yellow-600 hover:bg-yellow-50 dark:hover:bg-gray-500'
                                  }`}
                                >
                ...
                {selectedModerationId && moderationInfo.accountStatus !== 'BANNED' && (
                  <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/10 dark:to-blue-900/10 border-2 border-green-400 dark:border-green-600 rounded-xl p-4 md:p-5 space-y-4 shadow-md">
                    <div className="flex items-center gap-2 mb-2">
                            ...
                            >
                              <div className="flex items-center flex-1 min-w-0 gap-3">
                                <img 
                                  ...
                                  className="w-12 h-12 rounded-lg object-cover border-2 border-gray-200 dark:border-gray-600 flex-shrink-0" 
                                />
