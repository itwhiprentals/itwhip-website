        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
                    {bookingStep === 'rooms' && 'Select Your Room'}
                    {bookingStep === 'payment' && 'Payment Options'}
            ...
            <div className="p-4 md:p-6">
              {/* Room Selection Step */}
              {bookingStep === 'rooms' && bookingHotel.roomTypes && (
                <div className="space-y-4">
                  {/* Instant Ride Benefits Alert for Premium Hotels */}
                  {bookingHotel.tier === HOTEL_TIERS.PREMIUM && bookingHotel.instantRideValue && (
                    <div className="p-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 
                      dark:to-orange-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                      <div className="flex items-center space-x-3">
                        <IoCarSportOutline className="w-6 h-6 text-amber-600 dark:text-amber-400 flex-shrink-0" />
                        <div>
                          <p className="text-sm font-bold text-amber-700 dark:text-amber-300">
                            This booking includes ${bookingHotel.instantRideValue} in instant ride benefits!
                          </p>
                          <p className="text-xs text-amber-600 dark:text-amber-400 mt-1">
                            Your confirmation code will unlock luxury rides at member rates
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Room Options */}
                  {bookingHotel.roomTypes.map((room) => (
                    <div
                      key={room.id}
                    ...
                    >
                        ...
                        <div className="flex-1">
                          ...
                          {room.available <= 3 && (
                            <p className="text-xs text-red-600 dark:text-red-400 font-medium">
                              Only {room.available} {room.available === 1 ? 'room' : 'rooms'} left!
                            </p>
                          )}
                        </div>
                      ...
                      {selectedRoom?.id === room.id && (
                        <div className="mt-3 pt-3 border-t border-blue-200 dark:border-blue-800">
                          <IoCheckmarkCircle className="inline w-4 h-4 text-blue-500 mr-1" />
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">{bookingHotel.name}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">${selectedRoom.price}/night</span>
                      </div>
                      {bookingHotel.instantRideValue && bookingHotel.instantRideValue > 0 && (
                        <div className="flex justify-between text-green-600 dark:text-green-400">
                          <span>Instant Ride Benefits:</span>
                          <span className="font-bold">+${bookingHotel.instantRideValue} value</span>
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            Pay when you arrive, flexible cancellation
                          </p>
                        </div>
                      </label>
                    </div>
                ...
                <div className="text-center py-8">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Your reservation at {bookingHotel.name} is confirmed
                    </p>
                  </div>
                    ...
                    {bookingHotel.tier === HOTEL_TIERS.PREMIUM && (
                      <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                        ...
                        <span className="text-sm text-amber-700 dark:text-amber-300 font-medium">
                          This code unlocks ${bookingHotel.instantRideValue} in luxury ride benefits!
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button
                      onClick={() => {
                        closeModal()
                        // Could redirect to RiderView here
