                      ...
                      <div className="flex items-start justify-between">
                        ...
                        {!vehicle.isActive ? (
                          <button
                            ...
                            className="px-1.5 py-0.5 rounded text-[10px] font-medium uppercase border border-red-300 dark:border-red-600 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors cursor-pointer flex-shrink-0"
                          >
                            INACTIVE
                          </button>
                        ) : (
