    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
      ...
      {isSelfManaged && !management && (
        <div className="text-center py-6">
          ...
          <h3 className="text-gray-900 dark:text-white font-medium mb-1">Self-Managed</h3>
          ...
          <div className="p-4 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-shrink-0">
                {management.manager.profilePhoto ? (
                  ...
                  <div className="w-14 h-14 bg-purple-100 dark:bg-purple-900/50 rounded-full flex items-center justify-center">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <span className="flex items-center gap-1 px-2 py-1 bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-400 text-xs font-medium rounded-full">
                  ...
                  {management.manager.rating && (
                    <span className="flex items-center gap-1">
                      ...
                      {management.manager.totalTrips && (
                        <span>({management.manager.totalTrips} trips)</span>
                      )}
                    </span>
                  )}
                ...
                {/* Commission Split */}
                <div className="mt-3 p-2 bg-white dark:bg-gray-800 rounded border border-purple-100 dark:border-purple-800">
            ...
            <div className="mt-4 pt-4 border-t border-purple-200 dark:border-purple-700">
              <button
                ...
                disabled={removing}
                className="text-red-600 hover:text-red-700 dark:text-red-400 text-sm flex items-center gap-1"
              >
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    {invitation.recipient?.profilePhoto ? (
                      ...
                      <div className="w-10 h-10 bg-yellow-100 dark:bg-yellow-900/50 rounded-full flex items-center justify-center">
                        <IoPersonOutline className="w-5 h-5 text-yellow-600" />
                      </div>
                    )}
                    <div>
                  ...
                  <div className="text-right">
                    <span className="flex items-center gap-1 px-2 py-0.5 bg-yellow-100 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-400 text-xs font-medium rounded">
      ...
      {(management || pendingInvitations.length > 0) && isSelfManaged && (
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          <button
            onClick={onInviteHost}
            className="text-purple-600 hover:text-purple-700 dark:text-purple-400 text-sm flex items-center gap-1"
          >
            <IoAddCircleOutline className="w-4 h-4" />
            Invite Another Host
          </button>
