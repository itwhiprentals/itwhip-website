...
function SetPasswordForm() {
  ...
  const getPasswordStrength = (pwd: string) => {
    ...
    const levels = [
      ...
      { strength: 2, text: 'Fair', color: 'text-orange-400' },
      { strength: 3, text: 'Good', color: 'text-yellow-400' },
      { strength: 4, text: 'Strong', color: 'text-green-400' },
      { strength: 5, text: 'Very Strong', color: 'text-green-500' }
    ]
        ...
        <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4">
          <div className="max-w-sm w-full text-center">
            <div className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-lg p-6 mb-5">
              ...
              <h2 className="text-base font-bold text-gray-900 dark:text-white mb-2">Invalid Setup Link</h2>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">
                This link is invalid or has expired.
              </p>
              <p className="text-gray-500 text-xs">
                Check your email for the latest link or contact support.
              </p>
            </div>
        ...
        <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4">
          <div className="max-w-sm w-full text-center">
            <div className="bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 rounded-lg p-6">
              ...
              <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Account Secured!</h2>
