...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      {/* Header */}
      <Header
      ...
      <div className="pt-14 md:pt-16">
        <div className="flex min-h-[calc(100vh-56px)]">
            ...
            <div className="w-full max-w-md">
              ...
              <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-4 mb-6 border border-green-200 dark:border-green-800">
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-green-800 dark:text-green-300">Instant booking</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <IoCheckmarkCircle className="w-4 h-4 text-green-600" />
                    <span className="text-green-800 dark:text-green-300">Verified hosts</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <IoCheckmarkCircle className="w-4 h-4 text-green-600" />
                    <span className="text-green-800 dark:text-green-300">24/7 support</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <IoCheckmarkCircle className="w-4 h-4 text-green-600" />
                    <span className="text-green-800 dark:text-green-300">Best prices</span>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-2 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  {isLoading ? (
                    <>
          ...
          <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-green-600 to-emerald-700 p-12 items-center justify-center">
            <div className="max-w-md text-white">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-3">
                  <IoSparklesOutline className="w-6 h-6 text-green-300 flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <IoShieldCheckmarkOutline className="w-6 h-6 text-green-300 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold mb-1">Safe & Secure</h3>
                    <p className="text-green-100 text-sm">
                      All hosts verified, comprehensive insurance, 24/7 roadside assistance
                    </p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-3">
                  <IoRocketOutline className="w-6 h-6 text-green-300 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold mb-1">Instant Booking</h3>
                    <p className="text-green-100 text-sm">
                      Book in seconds, pick up within hours - car rental made easy
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-xs text-green-200">Cars Available</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">50,000+</div>
                    <div className="text-xs text-green-200">Happy Renters</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">4.8★</div>
                    <div className="text-xs text-green-200">Average Rating</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">100%</div>
                    <div className="text-xs text-green-200">Verified Hosts</div>
                  </div>
                </div>
              </div>
            </div>
