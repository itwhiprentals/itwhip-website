        ...
        <div className="px-6 py-3 bg-green-50 dark:bg-green-900/20 border-b border-green-200 dark:border-green-800">
          <div className="flex items-center">
            ...
            <p className="text-xs text-green-800 dark:text-green-200">
              <strong>Security Deposit Always Released:</strong> Your security deposit is released in full on any cancellation, regardless of timing.
              No damage = no deposit charge.
            </p>
          </div>
        </div>
          ...
          <div className="prose prose-sm max-w-none">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-between pt-5">
                      <div className="text-center w-1/2">
                        <p className="text-xs font-semibold text-green-700 dark:text-green-300">24+ hours before pickup</p>
                        <p className="text-xs text-green-600 dark:text-green-400">Full refund</p>
                      </div>
                      <div className="text-center w-1/2">
                        <p className="text-xs font-semibold text-amber-700 dark:text-amber-300">Less than 24 hours</p>
                        <p className="text-xs text-amber-600 dark:text-amber-400">1-day penalty*</p>
                      </div>
                    </div>
                  </div>
                  <p className="text-[10px] text-gray-500 mt-3 text-center">
                    *Trips 1-2 days: half-day penalty. Trips 3+ days: 1 full day penalty. Security deposit always released.
                  </p>
                </div>
              </div>
            </section>
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-3">
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600 dark:text-gray-400">Avg. Daily Cost:</span>
                      <span className="font-semibold text-gray-900 dark:text-white">${refund.avgDailyCost.toFixed(2)}</span>
                    </div>
                    {refund.penaltyAmount > 0 && (
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600 dark:text-gray-400">Penalty ({refund.penaltyDays === 1 ? '1 day' : 'half day'}):</span>
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-xs text-green-600 dark:text-green-400">Always released</span>
                    </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-amber-900 dark:text-amber-100 mb-2">Less Than 24 Hours Before Pickup &mdash; Late Cancellation</h4>
            ...
            <section className="mb-6">
              <h3 className="text-base font-semibold mb-3 text-gray-900 dark:text-white">Always Refunded on Cancellation</h3>
