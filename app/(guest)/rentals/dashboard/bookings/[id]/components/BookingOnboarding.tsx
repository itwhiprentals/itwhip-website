          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-semibold text-gray-900 text-sm sm:text-base">
                Onboard to Complete Your Booking
              </h3>
              <p className="text-xs text-gray-500 mt-0.5">
                {isPending
                  ? 'Available after booking is approved'
                  : isConfirmed && !needsStripeVerification
                    ? 'Upload your documents for this trip'
                    : 'Complete onboarding to finalize your booking'}
              </p>
            </div>
          </div>
      ...
      {needsStripeVerification ? (
          ...
          <div className="px-4 sm:px-6 py-3">
            <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-xs text-amber-800">
                <span className="font-medium">Save on your deposit:</span> Add your insurance during onboarding to receive a 50% deposit reduction.
              </p>
            </div>
          </div>
        ) : null
        ...
        <div className={`px-4 sm:px-6 py-4 space-y-2 ${isPending ? 'pointer-events-none' : ''}`}>
          ...
          <OnboardingItem
            ...
            subtitle={booking.guestInsuranceOnFile ? 'Using insurance from your profile' : undefined}
          />

          {!hasInsurance && !booking.guestInsuranceOnFile && (
            <div className="mt-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-xs text-amber-800">
                <span className="font-medium">Save on your deposit:</span> Upload your insurance to receive a 50% deposit reduction.
              </p>
            </div>
          )}
