  ...
  if (history.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 dark:text-gray-400">No insurance history yet</p>
        <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">
          Add insurance to start building your history
        </p>
      </div>
    )
  }
                      ...
                      <div className="pt-4 space-y-3">
                        ...
                        {entry.provider && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            {entry.coverageType && (
                              <div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Coverage Type</p>
                                <p className="text-sm font-medium text-gray-900 dark:text-white">
                            ...
                            <div>
                              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Rideshare Coverage</p>
                              <p className="text-sm font-medium text-gray-900 dark:text-white">
                                {entry.hasRideshare ? 'Yes' : 'No'}
                              </p>
                            </div>
                            ...
                            <div className="flex items-start space-x-2">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-green-700 dark:text-green-300 mt-1">
                                  {entry.verifiedBy} on {formatDate(entry.verifiedAt)}
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        {(entry.cardFrontUrl || entry.cardBackUrl) && (
                          <div className="mt-3">
                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Insurance Card Images</p>
