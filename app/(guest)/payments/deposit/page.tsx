  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg text-center mb-4">
        <p className="text-sm text-gray-600 dark:text-gray-400">Amount to load</p>
...
export default function DepositWalletPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Deposit Wallet</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          Preload funds for security deposits
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg p-6 text-white shadow-lg">
        ...
        <p className="text-sm opacity-75">For security deposits only</p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-800 dark:text-amber-300 mt-0.5">
              These funds can only be used for security deposits, not for paying rental fees.
              Deposits are held during your trip and released back to this wallet afterward.
            </p>
          </div>
        </div>
      </div>
      ...
      {showLoadFunds && clientSecret ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-semibold text-gray-900 dark:text-white">Add Funds</h3>
            <button
              onClick={() => {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-4">Add Deposit Funds</h3>
          ...
          >
            ...
            {creatingIntent ? 'Loading...' : `Add $${loadAmount} to Wallet`}
          </button>
        </div>
      )}
              ...
              <div key={tx.id} className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">
                    {tx.type === 'LOAD' && 'Funds Added'}
                    {tx.type === 'HOLD' && 'Deposit Held'}
                    {tx.type === 'RELEASE' && 'Deposit Released'}
