...
export async function GET(request: NextRequest) {
  try {
    ...
    const profile = {
      ...
      // Photo ID fields for dashboard verification
      photoIdType: host.photoIdType,
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const profile = {
      ...
      // Photo ID fields for dashboard verification
      photoIdType: updatedHost.photoIdType,
      ...
      revenuePath: updatedHost.revenuePath,
