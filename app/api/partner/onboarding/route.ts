  ...
  try {
    ...
    return NextResponse.json({
      ...
      request: {
        ...
        vehicleInfo: fleetRequest.vehicleInfo,
        guestName: fleetRequest.guestName,
        guestRating: fleetRequest.guestRating,
        guestTrips: fleetRequest.guestTrips,
        ...
        totalAmount: fleetRequest.totalAmount,
        hostEarnings: fleetRequest.hostEarnings,
        platformFee: fleetRequest.platformFee,
